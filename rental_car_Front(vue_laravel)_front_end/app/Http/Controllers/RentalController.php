...
class RentalController extends Controller
{
    ...
    public function index(Request $request)
    {
       ...
       /*  if($request->has("relationship")){
        ...
        return $clientFilter->filterShow(5);
    }
    ...
    public function show($id)
    {
        ...
        if($clientShow===null){
            return response()->json(['Error'=>'Rental não existe na base de dados!'],404);
        }
    ...
    public function destroy($id)
    {
        ...
        if ($rental === null) {
            return response()->json(["Error" => 'Locaçao não existe na base de dados!'], 404);
        }
