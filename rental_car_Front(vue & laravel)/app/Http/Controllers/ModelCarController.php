...
class ModelCarController extends Controller
{
    ...
    {   //instância de uma classe com os filtros
        ...
        return $modelFilter->filterShow(5);
    }
    ...
    {
        $modelSearched=$this->modelCar->with('brand')->find($id);

        if($modelSearched===null){
            return response()->json(['Error'=>'Modelo de carro não existe na base de dados!'],404);
        }
    ...
    public function destroy($id)
    {
        ...
        if($modelCarDeleted===null){
            return response()->json(['Error'=>'Modelo não existe na base de dados!'],404);
        }
